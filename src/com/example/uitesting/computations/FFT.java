...
public final class FFT {   
  ...
  final  float TWOPI=6.28318530717958647692f;   
  final  float SQHALF=0.707106781186547524401f;   
  ...
  */   
  public float[] calculateFFTMagnitudeX(float x[]) {   
        int i,n;   
    n=1<<this.logm;   
  ...
  * The returned vector contains only the positive frequencies.  
  */   
  public float[] calculateFFTMagnitude(float inputData[]) {   
        int i,n;   
        n=1<<this.logm;   
        ...
        //float[] dtest = DSP.DFTMagnitude(inputData);   
